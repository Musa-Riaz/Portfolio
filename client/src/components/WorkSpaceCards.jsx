...
const WorkSpaceCards = ({icon, title, children}) => {
  return (
    <div className='group w-[312px] h-[276px] rounded-xl bg-white shadow-lg  hover:shadow-2xl transform transition-transform duration-700 hover:-translate-y-2 hover:scale-105'>
